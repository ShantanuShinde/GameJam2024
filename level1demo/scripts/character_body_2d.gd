...
# Example die function in the player script
func die():
	queue_free()  # Remove the player from the scene (or restart the level)
	get_tree().reload_current_scene()  # You can restart the level like this
